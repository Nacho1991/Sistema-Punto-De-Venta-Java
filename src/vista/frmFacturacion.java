...
public class frmFacturacion extends javax.swing.JFrame implements KeyListener {
    ...
    public void imprimirFactura(int pNumeroMateriales) {
        try {
            ...
            maestro.setObservacion(txtObservacion.getText());
            ...
            p.generarArchivoPDF(txtNumeroFactura.getText(), txtObservacion.getText());
        } catch (Exception xp) {
    ...
    private void initComponents() {
        ...
        txtNumeroFactura.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 18)); // NOI18N
        txtNumeroFactura.setFocusable(false);

        txtLimiteCredito.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 18)); // NOI18N
        txtLimiteCredito.setFocusable(false);
            ...
            .addGroup(pnlEncabezadoLayout.createSequentialGroup()
                ...
                .addGroup(pnlEncabezadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlEncabezadoLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cmbTipoCliente, 0, 86, Short.MAX_VALUE))
                    .addGroup(pnlEncabezadoLayout.createSequentialGroup()
                ...
                .addGroup(pnlEncabezadoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtLimiteCredito, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE))
                .addGap(475, 475, 475))
        );
        ...
        lblVendedor.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        lblVendedor.setText("Vendedor:");

        lblFechaActual.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        lblFechaActual.setText("Fecha:");

        lblObservacion.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        lblObservacion.setText("Observación:");

        lblTotalPagar.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        lblTotalPagar.setText("Total a pagar:");

        lblDescuento.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        lblDescuento.setText("Descuento:");

        txtNombreVendedor.setEditable(false);
        txtNombreVendedor.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        txtNombreVendedor.setFocusable(false);

        txtFecha.setEditable(false);
        txtFecha.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N
        txtFecha.setFocusable(false);

        txtObservacion.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 18)); // NOI18N

        txtDescuento.setEditable(false);
        txtDescuento.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 18)); // NOI18N
        txtDescuento.setText("0");
        txtDescuento.setFocusable(false);

        txtTotalPagar.setEditable(false);
        txtTotalPagar.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 18)); // NOI18N
        ...
        pnlPieFrameLayout.setHorizontalGroup(
            ...
            .addGroup(pnlPieFrameLayout.createSequentialGroup()
                ...
                .addGroup(pnlPieFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblFechaActual, javax.swing.GroupLayout.Alignment.TRAILING))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pnlPieFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlPieFrameLayout.createSequentialGroup()
                        .addGroup(pnlPieFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtFecha, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE))
                        ...
                        .addGroup(pnlPieFrameLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTotalPagar, javax.swing.GroupLayout.DEFAULT_SIZE, 124, Short.MAX_VALUE))
                        .addGap(54, 54, 54))
                    .addGroup(pnlPieFrameLayout.createSequentialGroup()
                        .addComponent(txtObservacion, javax.swing.GroupLayout.PREFERRED_SIZE, 832, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlContenedorLayout.setVerticalGroup(
            ...
            .addGroup(pnlContenedorLayout.createSequentialGroup()
                .addComponent(pnlEncabezadoPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
